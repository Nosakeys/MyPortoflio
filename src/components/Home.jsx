  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <div>
          <button className="text-white group sm:border-[1px] py-4 px-4 sm:py-3 my-2 flex items-center hover:bg-[#5a3f2c] sm:hover:border-[#83573a] rounded-lg sm:rounded-[4px] sm:hover:rounded bg-[#5a3f2c]">
